@extends('layouts.app')
@section('title', 'Daftar Akun - ANHIVA')
...
<div class="auth-split">
    <div class="auth-split-left" style="position:relative; overflow:hidden; background:linear-gradient(135deg, var(--teal-800) 0%, var(--teal-600) 50%, var(--teal-400) 100%);">
        ...
        <div style="position:relative; z-index:1; max-width:400px;">
            ...
            <h2 style="font-size:2.5rem; color:white; margin-bottom:var(--space-lg); line-height:1.2;">Gabung Bersama Kami</h2>
            <p style="font-size:1.1rem; color:rgba(255,255,255,0.9); margin-bottom:var(--space-xl);">Daftar untuk membuat akun. Kami menjaga privasi Anda dengan sangat ketat melalui sistem anonim yang aman.</p>
    ...
    <div class="auth-split-right">
        <div style="width:100%; max-width:450px;">
            <div style="text-align:center; margin-bottom:var(--space-2xl);">
                <h2 style="font-size:2rem; font-weight:800; color:var(--gray-900);">Buat Akun Baru</h2>
                <p style="color:var(--gray-400);">Lengkapi data di bawah untuk mendaftar</p>
            ...
            <form method="POST" action="{{ route('register') }}" onsubmit="this.querySelector('button[type=submit]').innerHTML = '<i class=\'fas fa-spinner fa-spin\'></i> Memproses...'; this.querySelector('button[type=submit]').disabled = true;">
                @csrf
                
                <div class="form-group">
                    <label class="form-label" for="username">Username</label>
                    <input type="text" id="username" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" required autofocus placeholder="Masukkan username">
                    @error('username')
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required placeholder="contoh@email.com">
                </div>
                ...
                <div class="form-group" style="position:relative;">
                    ...
                    <div style="position:relative;">
                        ...
                        <button type="button" onclick="togglePassword('password', 'toggleIcon1')" style="position:absolute; right:10px; top:50%; transform:translateY(-50%); background:none; border:none; color:var(--gray-400); cursor:pointer;">
                ...
                <div class="form-group" style="position:relative;">
                    ...
                    <div style="position:relative;">
                        <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" required placeholder="Ulangi password" maxlength="20" style="padding-right: 40px;">
                        <button type="button" onclick="togglePassword('password_confirmation', 'toggleIcon2')" style="position:absolute; right:10px; top:50%; transform:translateY(-50%); background:none; border:none; color:var(--gray-400); cursor:pointer;">
                            <i class="fas fa-eye" id="toggleIcon2"></i>
                        </button>
                    </div>
                </div>

                <button type="submit" class="btn btn-primary btn-block btn-lg" style="margin-top:var(--space-xl); transition:all 0.3s;">Daftar Sekarang</button>
            </form>

            <div class="text-center mt-xl">
                <p style="color:var(--gray-400);">Sudah punya akun? <a href="{{ route('login') }}" style="font-weight:600;">Masuk di sini</a></p>
