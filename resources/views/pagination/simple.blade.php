...
<nav>
    <ul class="pagination">
        @if ($paginator->onFirstPage())
            <li class="page-item"><span class="page-link" style="opacity:0.5;"><i class="fas fa-chevron-left"></i></span></li>
        @else
        ...
        @else
            <li class="page-item"><span class="page-link" style="opacity:0.5;"><i class="fas fa-chevron-right"></i></span></li>
        @endif
    </ul>
</nav>
@endif
